...
<div class="sociograma">
	...
	if($codTurma===0)
		...
		<form action="./mostraGrafo.php" method="post">
			...
			<p>
				...
				<legend>Per�odo</legend>
					<table style="font-size: 10px; border-spacing: 5px;">
						<td>Data de in�cio: <input name="dataInicio" type="text" placeholder="01/01/2000" class="fonteFormatacao"></td>
			...
			<!--<p>
				<fieldset>
				<legend>Modo de exibi��o
					<span class="tooltip" onmouseover="xyz()" onmouseout="xyz()">(<u>?</u>)
                            <span id="tooltip-span" style="text-align:center" align="right">
                                <em>Deseja descobrir quem busca interagir com quem?</em>
                                <br> O modo <strong>neato n�o-direcionado</strong> � eficiente para analisar a intensidade de intera��es!<br>
                                <em>Gostaria de saber se est�o sendo formados grupos em tua turma?</em><br> Experimente o modo <strong>circo</strong>!
                            </span></span>
				</legend>
				...
				<!--<label>
					<input type="radio" name="layout" value="dot">Dot</label><br>
				<label>
					<input type="radio" name="layout" value="neato" checked>Neato</label><br>
				<label>
					<input type="radio" name="layout" value="circo">Circo</label><br>
				<br>
					<fieldset>
						<label>
							<input type="radio" name="directed" value="yes" checked>Direcionado</label><br>
						<label>
							<input type="radio" name="directed" value="no">N�o-direcionado</label><br>
					</fieldset>
				</fieldset>
			</p>-->
...
function imprimeNivel_Relevancia($tipo_rel){
	echo('<select  STYLE="font-size:8pt" name="rel'.$tipo_rel.'">
			...
			<option value="5">Extremamente importante</option>
		  </select>');
}
